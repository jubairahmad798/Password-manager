...
const Manager = () => {
    ...
    const getPasswords = async () => {
        let req = await fetch("https://password-manager-backend3.onrender.com")
    ...
    const savePassword = async () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            await fetch("https://password-manager-backend3.onrender.com", { method: "DELETE", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: form.id }) })

            setPasswordArray([...passwordArray, { ...form, id: uuidv4() }])
            await fetch("https://password-manager-backend3.onrender.com", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...form, id: uuidv4() }) })
    ...
    const deletePassword = async (id) => {
        ...
        if (c) {
            ...
            await fetch("https://password-manager-backend3.onrender.com", { method: "DELETE", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id }) })
